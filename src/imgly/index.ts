 ...
 * Import and call `initLayoutsEditor()` to configure a CE.SDK instance for layout-based design editing.
 *
 ...
 */
export async function initLayoutsEditor(cesdk: CreativeEditorSDK) {
  // ============================================================================
  // Configuration Plugin
  // ============================================================================
  ...
  await cesdk.addPlugin(
    new LayoutsAssetSourcePlugin({
      baseURL: 'https://img.ly/showcases/cesdk/cases/layouts'
    })
  );
  ...
  await cesdk.loadFromURL(
    'https://img.ly/showcases/cesdk/cases/layouts/custom-layouts.scene'
  );
}
