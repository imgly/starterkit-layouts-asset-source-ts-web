...
For complete integration guides and API reference, visit the [Layouts Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/layouts-editor-layot1/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.81.1-rc.0/starterkit-layouts-asset-source/demo-assets.zip
...
The default URL is the `DEMO_ASSETS_BASE_URL` constant in `src/imgly/plugins/layouts/layout.ts` if you
